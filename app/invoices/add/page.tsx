  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        <div
          onClick={() => router.push('/')}
          style={{ fontFamily: 'Georgia, serif', fontStyle: 'italic', fontSize: 21, color: '#1a1a18', cursor: 'pointer', letterSpacing: '-0.02em' }}
        >
        ...
        <div style={{ width: '100%', maxWidth: 520 }}>
          ...
          <div style={{ marginBottom: '2.2rem' }}>
            <div style={{
              ...
              background: '#f0efeb', border: '0.5px solid rgba(0,0,0,0.1)',
              color: '#6b6b66', fontSize: 12, fontWeight: 500,
              padding: '4px 13px', borderRadius: 100, marginBottom: 16,
            }}>
            ...
            <h1 style={{
              ...
              Who owes you <em style={{ color: '#1a7a4a' }}>money?</em>
            </h1>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div>
                ...
                <input
                  ...
                  type="email"
                  required
                  placeholder="e.g. sarah@studiobloom.com"
              ...
              <div>
                ...
                <input
                  ...
                  style={inputStyle}
                />
                <p style={{ fontSize: 12, color: '#a8a8a2', marginTop: 6 }}>
                  Paynelo starts following up automatically after this date.
                </p>
              </div>
              ...
              <div style={{ borderTop: '0.5px solid rgba(0,0,0,0.07)', paddingTop: 20, marginTop: 4 }}>
                <button
                  ...
                  style={{
                    width: '100%',
                    padding: '13px',
                    background: loading ? '#f0efeb' : '#0f1a10',
                    color: loading ? '#a8a8a2' : '#ffffff',
                    border: 'none',
                    borderRadius: 100,
                    fontSize: 15,
                    fontWeight: 500,
                ...
                <p style={{ textAlign: 'center', fontSize: 12, color: '#a8a8a2', marginTop: 12 }}>
                  Paynelo will never send an email without your approval.
                </p>
              </div>
